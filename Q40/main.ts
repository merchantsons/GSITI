...
function make_album(title: string, artist: string, tracks?: number):        
         { title: string; artist: string; tracks?: number }
   {        
    ...
    const album1 = make_album ('Ali Khan', 'Joosh',22);
    const album2 = make_album ('Ragaav','Neela Aasmaan',12);
    const album3 = make_album ('Mosaan','Uar Challa',16);
    const album4 = make_album ('Mars','Inigma');
