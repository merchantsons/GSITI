...
let newgstbinbig: string = "Khalid Ahmed"
guest_lst.unshift(newgstbinbig)
console.log(guest_lst)

//add guest to middle of list
let newgstinmid: string = "Javed Raza Khan"
let middleIndex: number = Math.floor(guest_lst.length/2)
guest_lst.splice(middleIndex,0, newgstinmid)
console.log(guest_lst)

//append to add new guest at end
let gstappend: string = "Naveed Noor"
