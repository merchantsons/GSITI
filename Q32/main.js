...
*/
// part 1
const current_users = ['Ruby', 'Amelia', 'OLIVIA', 'Georgina', 'Charlotte'];
// part 2
const new_users = ['Ruby', 'Amelia', 'Olivia', 'Emma', 'Georgina', 'Charlotte', 'Darcy'];
// part 3
...
for (const newUser of new_users) {
    ...
    if (lowercasedCurrentUsers.includes(lowercasedNewUser)) {
        console.log(`Username "${newUser} is already taken, Please entera new username.`);
    }
    else {
